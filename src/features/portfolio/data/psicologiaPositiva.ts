...
export const psicologiaPositivaDiscipline: PortfolioDiscipline = {
  id: 'psicologia-positiva',
  title: 'Psicologia Positiva',
  subtitle: 'Bem-estar, propósito e realização pessoal',
  coverImage: '/fotos-marcela/WhatsApp Image 2026-04-24 at 16.29.49 (2).jpeg',
  activities: [
    {
      id: 'ikigai',
    ...
    },
    {
      ...
      description:
        'A aula sobre o modelo PERMA foi essencial para que eu conseguisse organizar melhor os conhecimentos adquiridos ao longo da disciplina. Durante a aula, aprendi sobre os cinco pilares do bem-estar: emoções positivas, engajamento, relacionamentos, sentido e realização. O que mais me ajudou foi a possibilidade de refletir sobre cada um desses elementos na minha própria vida, identificando quais estavam mais presentes e quais eu precisava desenvolver mais. Essa aula funcionou como uma síntese dos conteúdos estudados e me ajudou a compreender o bem-estar de forma mais estruturada e completa.\n\nUm dos pontos mais enfatizados na aula foi o papel das emoções positivas. Aprendi que elas vão muito além de sentimentos momentâneos de alegria ou prazer, pois exercem uma função fundamental no desenvolvimento psicológico. Esse entendimento se relaciona com a ideia de que emoções positivas ajudam a construir recursos pessoais duradouros, tanto no aspecto emocional quanto social. Além disso, percebi que cultivar essas emoções no dia a dia pode impactar diretamente a forma como lidamos com adversidades.\n\nNessa aula, ao final, recebemos algumas palavras embaralhadas para solucionar, mas também havia letras que não formavam nenhuma palavra, o que me causou preocupação por não saber solucionar.'
    },
    {
      id: 'circulo-apoio',
